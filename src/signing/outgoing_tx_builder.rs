...
use tari_transaction_components::{
    ...
    transaction_components::{
        memo_field::MemoField, OutputFeatures, TransactionError, WalletOutputBuilder,
    },
    TransactionBuilder,
};
...
impl OutgoingTxBuilder {
    ...
    pub async fn build_tx(
        ...
        let mut builder =
            TransactionBuilder::new(consensus_constants, builder_key_manager, network)
                .await
